function sorted_image_arrays = sort_images_adv(image_cell_array, type)
...
for i = 1:length(image_cell_array)
    img = imread(image_cell_array{i});
     if strcmp(type, 'bw')
         all_image_features(i,:) = extractFeatures_adv_bw(img, n, m, n2, m2);
     else
         all_image_features(i,:) = extractFeatures_adv(img, n, m, n2, m2);
     end
...
% ADD MORE CATEGORIES
sorted_image_arrays = {rocky_imgs, greenery_imgs};
